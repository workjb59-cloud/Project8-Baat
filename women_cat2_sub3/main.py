...
# Hardcoded subcategory URLs for Skin Care Group 3
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/women/skin-care/face-sunscreen/l/",
    "https://www.boutiqaat.com/ar-kw/women/skin-care/after-sun-care/l/",
    "https://www.boutiqaat.com/ar-kw/women/skin-care/tanning-lotions-bronzers/l/",
    "https://www.boutiqaat.com/ar-kw/women/skin-care/self-tanning/l/",
    "https://www.boutiqaat.com/ar-kw/women/skin-care/body-sunscreen/l/",
    "https://www.boutiqaat.com/ar-kw/women/skin-care/lip-balms/l/",
    "https://www.boutiqaat.com/ar-kw/women/skin-care/lip-scrubs-treatments/l/",
    "https://www.boutiqaat.com/ar-kw/women/skin-care/skin-care-tools/l/",
    "https://www.boutiqaat.com/ar-kw/women/skin-care/skin-care-value-gift-sets/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self):
        ...
        logger.info("=" * 80)
        logger.info("Starting Boutiqaat Data Pipeline - Skin Care Group 3 (Sequential)")
        logger.info("=" * 80)
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/skin-care/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/skin-care/excel-files"
            )
